jQuery(document).ready(function () {
  $(".first").click(function () {
    $(".arrow-down").css({ 'margin-left': '3vh' });
    $(".title").html("About us");
  ...
  $(".third").click(function () {
    $(".arrow-down").css({ 'margin-left': '30vh' });
  ...
  $(".fourth").click(function () {
    $(".arrow-down").css({ 'margin-left': '43vh' });
  ...
  $(".fifth").click(function () {
    $(".arrow-down").css({ 'margin-left': '57vh' });
  ...
  $(".sixth").click(function () {
    $(".arrow-down").css({ 'margin-left': '70vh' });
  ...
  $(".seventh").click(function () {
    $(".arrow-down").css({ 'margin-left': '84vh' });
